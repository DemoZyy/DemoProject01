...
public class ListMethodsTest {
    ...
    @Test
    public void testRemoveByValue() throws InterruptedException, JSONException {
        DataSyncTestHelper.setupSettingsOn(playerString, pubnub, true);
        ...
        String track = (String) tracks.removeByValue("track#2");
        assertEquals("track#2", track);
    ...
    @Test
    public void testReplaceByValue() throws InterruptedException, JSONException {
        DataSyncTestHelper.setupSettingsOn(playerString, pubnub, true);
        ...
        String track2 = (String) tracks.replaceByValue("track#3", "hi");
        assertEquals("track#3", track2);
