...
public class HereNowEndpointTest extends TestHarness {
    ...
    public void testMultipleChannelStateSync() throws PubNubException, InterruptedException {
        ...
        Assert.assertEquals(response.getChannels().get("ch1").getOccupants().get(0).getState().toString(), "{age=10.0}");
        ...
        Assert.assertEquals(response.getChannels().get("ch2").getOccupants().get(0).getState().toString(), "{age=10.0}");
        Assert.assertEquals(response.getChannels().get("ch2").getOccupants().get(1).getUuid(), "user3");
        Assert.assertEquals(response.getChannels().get("ch2").getOccupants().get(1).getState().toString(), "{age=30.0}");
